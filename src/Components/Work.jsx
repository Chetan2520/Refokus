...
:{...item,isActive:true}
  ...
  return (
    ...
    <h1 className='select-none text-white text-[25vw] leading-none font-medium tracking-tight'>    WORK</h1>
     <div className=' absolute top-0 w-full h-full '>
{images.map((elem,index)=>(elem.isActive &&  ( <img className='w-60 absolute  rounded-lg -translate-x-[50%] -translate-y-[50%] ' src={elem.url} style={{top:elem.top,left:elem.left}} />)
    )
)}
</div>
      </div>
